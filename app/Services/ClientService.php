...
class ClientService
{
     ...
     *
     * This method handles the creation of a new Client user, including their
     * associated metadata and accounts. It also assigns the "Client" role
     * to the user. The method performs the operations within a database
     * transaction to ensure atomicity.
     *
     * @param ClientRequest $request The request object containing the Client
