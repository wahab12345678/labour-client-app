            ...
            <section id="basic-datatable">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in">
                    <div class="modal-dialog sidebar-sm">
                        <form id="store-client" class="add-new-record modal-content pt-0" method="POST" action="{{ route('admin.client.store') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="modal-body flex-grow-1">
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control client-phone" id="basic-icon-default-fullname" name="phone" placeholder="Enter Phone Number" aria-label="03002200222"   pattern="03[0-9]{9}" maxlength="11"  oninput="this.value=this.value.replace(/[^0-9]/g,'')"  required/>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" class="form-control client-cnic_no" id="basic-icon-default-fullname" name="cnic_no" placeholder="Enter CNIC without dashes" aria-label="3660100000000"    pattern="[0-9]{13}" maxlength="13"   oninput="this.value=this.value.replace(/[^0-9]/g,'')" required/>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="file" class="form-control client-cnic_front_img" id="basic-icon-default-fullname" name="cnic_front_img" required/>
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="file" class="form-control client-cnic_back_img" id="basic-icon-default-fullname" name="cnic_back_img" required/>
...
@section('footer')
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/client/custom.js"></script>
    <!-- END: Page JS-->
@endsection
