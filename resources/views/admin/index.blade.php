...
<head>
    ...
    <meta name="description" content="{{env('APP_NAME')}} admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, {{env('APP_NAME')}} admin template, dashboard template, flat admin template, responsive admin template, web app">
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login.post') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="email" type="text" name="email" placeholder="john@example.com" value="{{ old('email') }}" />
