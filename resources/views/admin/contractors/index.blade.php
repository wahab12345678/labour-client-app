        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Contractor</h2>
            ...
            <section id="basic-datatable">
                ...
                <div class="modal modal-slide-in fade" id="modals-slide-in">
                    <div class="modal-dialog sidebar-sm">
                        <form id="store-contractor" class="add-new-record modal-content pt-0" method="POST" action="{{ route('admin.contractor.store') }}" enctype="multipart/form-data">
                            @csrf
              ...
              <div class="modal modal-slide-in fade" id="modals-slide-in-edit">
                <div class="modal-dialog sidebar-sm">
                    <form id="update-contractor" class="add-new-record modal-content pt-0" method="POST" action="{{ route('admin.contractor.update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <input type="hidden" class="contractor_id" id="contractor_id" name="contractor_id" />
...
@section('footer')
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../app-assets/js/contractor/custom.js"></script>
    <!-- END: Page JS-->
@endsection
