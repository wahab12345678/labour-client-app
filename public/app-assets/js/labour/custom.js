...
$(function () {
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          columnDefs: [
            ...
            {
              targets: 2, // Category name
              render: function (data, type, full, meta) {
                return full.category_name; // Directly render the category name
              }
            },
            {
              targets: 3, // Phone
            ...
            {
              targets: 5, // CNIC number
              render: function (data, type, full, meta) {
                return full.cnic_no; // Render CNIC number
              }
            },
            {
              targets: 6, // CNIC front image
              render: function (data, type, full, meta) {
          ...
          buttons: [
            {
              text: feather.icons['plus'].toSvg({ class: 'me-50 font-small-4' }) + 'Add New Labour',
        ...
        $('div.head-label').html('<h6 class="mb-0">List of Labours</h6>');
    }
    ...
    // Add New Labour
    // on submit of form
    $('#store-labour').on('submit', function (e) {
        e.preventDefault();
