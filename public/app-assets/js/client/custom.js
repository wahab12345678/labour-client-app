...
$(function () {
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
          ...
          buttons: [
            {
              text: feather.icons['plus'].toSvg({ class: 'me-50 font-small-4' }) + 'Add New Client',
        ...
        $('div.head-label').html('<h6 class="mb-0">List of Clients</h6>');
    }
    ...
    // Add New Client
    // on submit of form
    $('#store-client').on('submit', function (e) {
        e.preventDefault();
